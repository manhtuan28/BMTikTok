...
@protocol BMDownloadDelegate <NSObject>
@optional
...
@interface BMDownload () <NSURLSessionDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSURLSessionStreamDelegate>
