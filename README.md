...
- **Ẩn Nút AI Tako**: Loại bỏ nút trợ lý AI trên màn hình xem video.
- **Ẩn Biểu Tượng Play/Pause**: Trải nghiệm xem video liền mạch, không che màn hình.
- **Khởi Động Tab Đang Theo Dõi**: Mở app thẳng vào Following thay vì Dành cho bạn.
- **Khóa Vuốt Ngang**: Chống vô tình nhảy sang camera hoặc profile.
...
- **Xóa Watermark Ảnh & Bản Nháp**: Lưu ảnh story và draft không dính watermark.
...
- **Xem Profile Ẩn Danh**: Ghé thăm trang cá nhân không lưu lịch sử xem.
- **Chống Phát Hiện Chụp / Quay Màn Hình**: Chặn gửi cảnh báo trong tin nhắn riêng.
- **Ẩn Trạng Thái Online**: Tắt chấm xanh hoạt động trực tuyến.
...
- **Mở Hàng Loạt Câu Trả Lời**: Tự động unfold toàn bộ thread reply.
- **Ẩn Thanh Emoji Nhanh**: Tối ưu diện tích màn hình khi gõ.
...
- **Lặp Lại Story**: Tự động loop video Story & dừng tự động chuyển ảnh.
...
- **Tích Xanh Giả Lập**: Gắn huy hiệu Verified trên trang cá nhân cá nhân.
...
- **Ẩn Huy Hiệu Đỏ**: Tắt chấm đỏ thông báo Friends và Inbox.
...
git add .
git commit -m "Initial commit for BMTikTok by Tuancute28"
git branch -M main
